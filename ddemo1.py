        ...
        if topic=='Pandas':
            ...
            with col1:  
                if st.button('Read PDF Tutorial',key='1'):            
                    show_pdf('SSVF HP Screener v6 9.2021.pdf')
            with col2:
            ...
            with st.container():
                ...
                with text_col:
                    ...
                    st.markdown("By Sharone Li - If you have been following my Medium blog for some time, you may notice that I usually like to share... [Continue to Read on CodeX](https://acrobat.adobe.com/link/review?uri=urn:aaid:scds:US:cf4899fd-c9d2-4d23-a058-fdb9e9876156)")
